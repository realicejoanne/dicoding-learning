package trianne.dicoding.dicodingnotesapp;
...
import trianne.dicoding.dicodingnotesapp.entity.NoteItem;

import static trianne.dicoding.dicodingnotesapp.db.DatabaseContract.CONTENT_URI;
        ...
        alertDialogBuilder
                ...
                .setPositiveButton("Ya",new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog,int id) {
                        ...
                        Toast.makeText(FormActivity.this, "Satu catatan berhasil dihapus", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                })
