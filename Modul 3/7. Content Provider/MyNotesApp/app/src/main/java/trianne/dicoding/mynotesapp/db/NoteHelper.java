package trianne.dicoding.mynotesapp.db;
...
import static trianne.dicoding.mynotesapp.db.DatabaseContract.TABLE_NOTE;
...
public class NoteHelper {
    ...
    //digunakan oleh kelas content provider untuk akses data
