...
public class MovieAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView             = mInflater.inflate(R.layout.items_movie, null);
            ...
            holder.imgPoster        = (ImageView)convertView.findViewById(R.id.imgMoviePoster);
        ...
        Picasso.get().load("http://image.tmdb.org/t/p/w154/"
                + mData.get(position).getMov_image()).placeholder(context.getResources().getDrawable(R.drawable.ic_image_black_50dp)).error(context.getResources().getDrawable(R.drawable.ic_image_black_50dp)).into(holder.imgPoster);
