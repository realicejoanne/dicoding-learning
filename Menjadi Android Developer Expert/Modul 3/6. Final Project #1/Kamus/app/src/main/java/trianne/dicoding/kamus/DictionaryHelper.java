...
import static trianne.dicoding.kamus.DatabaseContract.KamusColumns.FIELD_MEANING;
import static trianne.dicoding.kamus.DatabaseContract.KamusColumns.FIELD_WORD;
import static trianne.dicoding.kamus.DatabaseContract.TABLE_ENG_TO_IND;
import static trianne.dicoding.kamus.DatabaseContract.TABLE_IND_TO_ENG;
...
public class DictionaryHelper {
    ...
    public ArrayList<DictionaryModel> getDataByName(String search, String selection){
        ...
        if(selection == "Eng"){
            ...
            cursor = database.query(TABLE_IND_TO_ENG,null,FIELD_WORD+" LIKE ?",new String[]{search.trim()+"%"},null,null,_ID + " ASC",null);
