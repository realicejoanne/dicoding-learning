package trianne.dicoding.mynotesapp.provider;
...
import static trianne.dicoding.mynotesapp.db.DatabaseContract.AUTHORITY;
...
public class NoteProvider extends ContentProvider {
    ...
    //artinya kita akan mencoba untuk akses data table Note dari provider NoteProvider
    static {
        // content://trianne.dicoding.mynotesapp/note
        sUriMatcher.addURI(AUTHORITY, DatabaseContract.TABLE_NOTE, NOTE);

        // content://trianne.dicoding.mynotesapp/note/id
