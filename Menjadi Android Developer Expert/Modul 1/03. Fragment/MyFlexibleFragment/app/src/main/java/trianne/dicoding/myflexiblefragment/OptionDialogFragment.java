...
public class OptionDialogFragment extends DialogFragment implements View.OnClickListener {
    //Inherit DialogFragment agar obyek fragment sekarang merupakan obyek dialog yang akan tampil mengambang di layar
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_choose:
                ...
                if (checkedRadioButtonId != -1) {
                    ...
                    //ketika pengguna mengklik tombol Pilih setelah mengklik salah satu pilihan, baris ini akan dieksekusi:
