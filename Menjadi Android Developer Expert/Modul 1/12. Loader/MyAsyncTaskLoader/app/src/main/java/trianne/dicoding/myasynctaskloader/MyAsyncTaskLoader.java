package trianne.dicoding.myasynctaskloader;
...
public class MyAsyncTaskLoader extends AsyncTaskLoader<ArrayList<WeatherItems>> {
    ...
    private static final String API_KEY = "b117077825a710062e0ee3c794d04cf3";
    ...
    public ArrayList<WeatherItems> loadInBackground() {
        //Menjalankan proses pengambilan data secara synchronous
