...
public class ContactAdapter extends CursorAdapter {
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        //Parameter pertama pada metode inflate() menandakan berkas layout xml mana yang mau dikonversi.
        //Parameter kedua berisi obyek induk dari view yang akan ditancapkan ke dalam obyek ListView.
        //Obyek induk ini akan menjadi childView dari ListView. Parameter ketiga bernilai false karena
        //kita tidak ingin hasil konversi menjadi bagian atau childview dari layout utama (activity_main.xml).
