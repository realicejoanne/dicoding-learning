...
public class ImageBannerWidget extends AppWidgetProvider {
    ...
    public static final String TOAST_ACTION = "trianne.dicoding.TOAST_ACTION";
    public static final String EXTRA_ITEM = "trianne.dicoding.EXTRA_ITEM";

    static void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
                                int appWidgetId) {

        //RemoteAdapter ke dalam widget menggunakan Intent dan nilai id dari RemoteView yaitu stack_view
