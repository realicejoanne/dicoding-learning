package trianne.dicoding.myfirebasecloudmessaging;
...
/*
Cara pakai cek https://www.dicoding.com/academies/14/tutorials/1289?from=542
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        subscribeButton.setOnClickListener(new View.OnClickListener() {
            //untuk melakukan subscribe atau berlangganan topic “news”
            @Override
