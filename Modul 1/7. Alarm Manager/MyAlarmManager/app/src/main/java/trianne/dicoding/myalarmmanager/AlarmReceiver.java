...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    private void showAlarmNotification(Context context, String title, String message, int notifId){
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                .setSmallIcon(R.drawable.ic_alarm_black_36dp)
    ...
    public void setOneTimeAlarm(Context context, String type, String date, String time, String message){
        ...
        calendar.set(Calendar.MONTH, Integer.parseInt(dateArray[1])-1); //Data kurang 1 krn mulai dr indeks 0
    ...
    public void setRepeatingAlarm(Context context, String type, String time, String message){
        ...
        //Obyek PendingIntent dijalankan di setiap waktu yang ditentukan dalam milisecond dengan interval per hari
