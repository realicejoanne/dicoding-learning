...
import static trianne.dicoding.customnotif.NotificationService.CHANNEL_ID;
import static trianne.dicoding.customnotif.NotificationService.CHANNEL_NAME;
import static trianne.dicoding.customnotif.NotificationService.REPLY_ACTION;
...
public class NotificationBroadcastReceiver extends BroadcastReceiver {
    ...
    //untuk menerimanya inputan dari direct message bisa dengan menggunakan method onReceive
    @Override
    ...
    //Tidak perlu menambahkan remote input secara terus menerus.
    //Yang perlu dilakukan adalah update notifikasi dengan notification manager.
